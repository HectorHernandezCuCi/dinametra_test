...
import fetchData from "./helpers/fetchAsteroidsData";
import { AsteroidsData, AsteroidData } from "./types/asteroids";
import Loading from "../components/Loading";
import Header from "../components/Header";
import HeroSectionAsteroids from "./components/HeroSectionAsteroids";
import SearchSection from "./components/SearchSection";
import AsteroidGrid from "./components/AsteroidGrid";
import AsteroidDetailModal from "./modals/AsteroidDetailModal";
...
export default function AsteroidsPage() {
  ...
  // Filter asteroids by name and date
