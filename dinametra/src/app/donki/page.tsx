...
import fetchDonkiCoronalMassEjection from "./helpers/fetchDonkiCoronalMassEjection";
import { CoronalMassEjection } from "./types/donki";
import Header from "../components/Header";
import HeroSectionDonki from "./components/HeroSectionDonki";
...
export default function Donki() {
  ...
  if (error) return (
    <div className="min-h-screen bg-space-dark flex items-center justify-center p-4">
      <div className="bg-space-darker/80 backdrop-blur-lg border border-solar-red/30 rounded-xl p-8 max-w-md text-center">
  ...
  if (data.length === 0) return (
    <div className="min-h-screen bg-space-dark flex items-center justify-center p-4">
      <div className="bg-space-darker/80 backdrop-blur-lg border border-space-light/20 rounded-xl p-8 max-w-md text-center">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="space-y-6">
            {data.map((cme, index) => (
              <div 
                key={index} 
                className={`bg-space-darker/80 backdrop-blur-lg border rounded-xl overflow-hidden transition-all duration-500 ${
                  expandedCard === index 
